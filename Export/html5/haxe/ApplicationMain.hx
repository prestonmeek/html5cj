...
class ApplicationMain
{
	...
	{
		lime.system.System.__registerEntryPoint("html5cj", create);

		#if (js && html5)
		#if (munit || utest)
		lime.system.System.embed("html5cj", null, 760, 480);
		#end
		#else
		create(null);
		#end
	...
	public static function create(config):Void
	{
		...
		app.meta["build"] = "1";
		app.meta["company"] = "Preston";
		app.meta["file"] = "html5cj";
		app.meta["name"] = "Card Jitsu";
		app.meta["packageName"] = "com.sample.html5cj";
